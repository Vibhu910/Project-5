...
static void print_header(void) {
    ...
    printf("\n");
    printf("%-12s %-3s %-12s %-6s %-6s %-16s %-5s %-6s %-15s %-10s %-10s %-10s %-8s %-6s %-15s %-10s %-15s %-12s %-20s\n",
           "EVENT", "CPU", "TIME(s)", "PID", "TGID", "COMM", "PRIO", "STATIC", "VRUNTIME(ns)", "VLAG", "SLICE", "SUM_EXEC", "LOAD_WT", "ON_RQ", "STATE",
           "PREV_PID", "PREV_VR", "WQ_TYPE", "WQ_ADDR");
    printf("%-12s %-3s %-12s %-6s %-6s %-16s %-5s %-6s %-15s %-10s %-8s %-6s %-15s %-6s %-15s %-10s %-15s %-12s %-20s\n",
           "-----------", "---", "------------", "------", "------", "----------------", "-----", "------",
           "---------------", "----------", "--------", "------", "---------------", "------", "---------------", "----------", "---------------", "------------", "--------------------");
    header_printed = 1;
}
...
static void print_event_row(const struct sched_event *e) {
    ...
    printf("%-12s %-3d %-12s %-6u %-6u %-16.16s %-5d %-6d %-15s %-10s %-10s %-10s %-8llu %-6u %-15.15s %-10u %-15s %-12s %-20s\n",
    ...
    printf("    policy=%s nice=%d",
           policy_str(e->policy), e->nice);
...
int main(int argc, char **argv)
{
    ...
    printf("Tracing CFS internals: vruntime, weights, wait/ready queues\n");
    ...
    printf("Extra line per event: policy, nice; SWITCH shows voluntary/preempted + prev_state; WAKEUP shows wake_cpu.\n");
